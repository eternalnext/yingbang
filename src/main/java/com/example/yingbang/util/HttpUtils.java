package com.example.yingbang.util;
...
public class HttpUtils {
     ...
     * @return 图片名称
     */
    public static String doGetImage(String url,int id) throws IOException {
        //获取HTTPClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        ...
        try {
            ...
            if(response.getStatusLine().getStatusCode() == 200){
                ...
                if(response.getEntity() != null) {
                    ...
                    picName = "id" + id + extName;
                    //下载图片
                    //声明OutputStream
                    OutputStream outputStream = new FileOutputStream(new File("F://douban_data/" + picName));
